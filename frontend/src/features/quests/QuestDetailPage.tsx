...
import { ArrowLeft, Crown, Compass, ExternalLink, MapPin, Check, Circle, Loader2, GitBranch } from 'lucide-react';
...
import QuestObjectiveList from './components/QuestObjectiveList';
import { useQuestProgress, STATUS_CONFIG } from './hooks/useQuestProgress';
...
export default function QuestDetailPage() {
  ...
  const { userStatus, statusCfg, statusUpdating, completedObjectives, handleStatusChange } =
    useQuestProgress({ questId, objectives, questLoaded: !!quest });
